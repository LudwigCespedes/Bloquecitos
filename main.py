...
class Menu(Board,Player):
    ...
    def A_LAS_CHICAS_DE_VERDAD_LES_GUSTA__POLLO_FRITO (self):
        pass
        ...
        while True:
            try:
                ...
                if num_players == 2 or  num_players == 4:
                    ...
                    print("Número de jugadores no válido. Debe ser  2 y 4.")
            except ValueError:
                print("Entrada no válida. Por favor ingrese un número  2 y 4.")
    ...
    def choose_position(self, piece, corners_only=False):
        self.init_peace=[[0, 0],[0, 19],[19, 0],[19, 19]]
        while True:
            if corners_only:
                print("Debes colocar la pieza en una esquina. Esquinas disponibles:")
                for i,j in enumerate(self.init_peace):
                    print(f"{i+1}: {j}")
